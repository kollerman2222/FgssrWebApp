...
namespace fgssr.Data.Migrations
{
    ...
    [Migration("20240729084037_add_subjectmark_table")]
    partial class add_subjectmark_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("fgssr.Models.ChatMessages", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("fgssr.Models.SubjectMark", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("fgssr.Models.SubjectMark", b =>
                {
                    b.HasOne("fgssr.Models.ApplicationUser", "Student")
                        .WithMany("SubjectMark")
                        .HasForeignKey("StudentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("fgssr.Models.Subjects", "Subject")
                        .WithMany("SubjectMark")
